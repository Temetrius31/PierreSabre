...
public class Yakuza extends Humain {
	...
	public void extorquer(Commercant victime) {
		...
		gagnerArgent(gain);
		reputation++;
		System.out.println(parler("J'ai piqué les " + gain + " sous de " + victime.getNom() + ", ce qui me fait "
				+ getArgent() + " sous dans ma poche. Hi ! Hi!"));
	}

	public int perdre() {
		System.out.println(parler("J’ai perdu mon duel et mes " + getArgent()
	...
	public void gagner(int gain) {
		gagnerArgent(gain);
		reputation++;
		System.out.println(parler("Ce ronin pensait vraiment battre " + getNom() + " du clan de " + getClan()
	...
	public void direBonjour() {
		...
		System.out.println(parler("Mon clan est celui de " + getClan()));
	}
